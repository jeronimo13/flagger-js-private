(function (global, factory) {
  ...
  function standardBrowserEnv() {
    return {
      ...
      remove: function remove(name) {
        this.write(name, '', now$1() - 86400000);
      }
    };
    ...
    _createClass(Store, [{
      ...
      value: function get(key) {
        if (key in this.store) {
          ...
          throw new Error("Key ".concat(key, " not in store"));
        }
      }
    }, {
      key: "setGatingInfo",
      value: function setGatingInfo(gatingInfo) {
        var flagMap = this._getFlagMap(gatingInfo);
      ...
      key: "_getFlagMap",
      value: function _getFlagMap(gatingInfo) {
        var map = {};
        var flags = gatingInfo.flags;

        for (var i = 0; i < flags.length; i++) {
          var flag = assign$1({}, flags[i]);
  ...
  var Flagger$1 =
  /*#__PURE__*/
  function (_FlaggerCore) {
    _inherits(Flagger, _FlaggerCore);
